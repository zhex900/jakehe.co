...
draft: false
summary: 'A painful round about journey of getting AWS IoT SDK to work with electronjs in any platform.'
layout: PostSimple
---

## Overview

I have simple project requirement, build an cross platform app that can work with AWS IoT Services. Electron is
